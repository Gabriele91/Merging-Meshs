...
namespace Easy3D {
    ...
    public:
        ...
        virtual BaseVertexBufferObject* createStreamVBO(const byte* vbo, size_t stride, size_t n)=0;
        virtual BaseIndextBufferObject* createStreamIBO(const uint* ibo, size_t size)=0;
        ...
        virtual void updateSteamVBO(BaseVertexBufferObject* vbo, const byte* vb, size_t n)=0;
        virtual void updateSteamIBO(BaseIndextBufferObject* vbo, const uint* ib, size_t n)=0;
		...
		virtual void drawArrays(TypeDraw type, uint start,uint size)=0;
