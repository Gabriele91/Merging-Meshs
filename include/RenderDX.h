...
namespace Easy3D {
    ...
    public:
		...
		virtual BaseIndextBufferObject* createStreamIBO(const uint* vbo, size_t size);
		...
		virtual void updateSteamIBO(BaseIndextBufferObject* ibo, const uint* ib, size_t n);
